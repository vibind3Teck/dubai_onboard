...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Dubai</b>D3-Yacht</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url('auth/loginValidate');?> "method="post">
...
<!-- AdminLTE App -->
<script src="<?php echo base_url('public/theme/dist/js/adminlte.min.js')?>"></script>
</body>
</html>
